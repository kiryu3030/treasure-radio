...
class PlaybackManager:
    ...
    def play_wav_from_url(self, src: str, save_path: str, sio: socketio.Client, osc: SimpleUDPClient):
      """
...
MAXclient = SimpleUDPClient("127.0.0.1", 8083)
...
def on_play_audio(data):
    ...
    if name==player.name and player.is_playing:
        ...
        return
    player.play_wav_from_url(url, path, sio=sio, osc=MAXclient)
...
try:
    ...
    if lastAudio:
      ...
      player.play_wav_from_url(lastAudio, '', sio=sio, osc=MAXclient)
    time.sleep(5)
